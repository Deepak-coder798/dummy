      ...
      {show && <div style={{ position: "fixed", zIndex: "1", width: '100%', height: "100%", background: "rgba(0,0,0,0.6)", display: 'flex', justifyContent: "center", alignItems: "center", left: "0", top: "0" }}>
        <div style={{ height: "70%", width: "50%", background: "white", borderRadius: '8px', display: "flex", position: "relative" }}>
          ...
          <div style={{ width: "50%" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", position: "absolute", bottom: "0" }}>
              <input type='text' value={comment} onChange={(e) => setComment(e.target.value)}></input>
              <IoMdSend onClick={() => addComment(imageUrl._id)} />
            </div>
          </div>
        </div>
      </div>}
